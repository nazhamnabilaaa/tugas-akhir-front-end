...
export default function Page() {
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        try {
          ...
          setTanggalprofesiList(tanggalprofesiList.filter((item) => item.kdtunjangan !== kdtunjangan))
  ...
  useEffect(() => {
    if (!tanggalprofesiList.length) return

    const filtered = tanggalprofesiList.filter(
    ...
    <section className="text-black px-4 md:px-16">
      ...
      <div className="max-w-6xl mx-auto bg-white p-4 md:p-6 rounded-lg shadow-lg mt-10">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-4">
          <h2 className="text-xl md:text-2xl font-bold mb-4 md:mb-0">TUNJANGAN PROFESI</h2>
        </div>
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-4 mt-8 space-y-4 md:space-y-0">
          ...
          <div className="flex space-x-2 w-full md:w-auto">
            <Link
              href="/dosen/pembayaran/tambah-profesi"
        ...
        <div className="overflow-x-auto">
          <table className="min-w-full bg-white border-collapse border-black border responsive-table">
            <thead className="border">
              <tr className="border">
                ...
                <th className="border border-gray-300 px-6 py-4 text-center">Tanggal</th>
                  ...
                  <tr key={index} className="border">
                    ...
                    <td className="px-6 border border-gray-300 py-4 text-center">
                      <div className="flex justify-center space-x-2">
                        <Link href={`/dosen/pembayaran/lihat-profesi/${item.kdtunjangan}`}>
