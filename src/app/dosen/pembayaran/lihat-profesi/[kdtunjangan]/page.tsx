  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.status === 200) {
        ...
        router.push(`/dosen/pembayaran/lihat-profesi/${formData.kdtunjangan}`)
      } else {
    ...
    <section className="text-black px-4 md:px-16">
      ...
      <div className="max-w-6xl mx-auto bg-white p-4 md:p-6 rounded-lg shadow-lg mt-10">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-4">
          <h2 className="text-xl md:text-2xl font-bold mb-4 md:mb-0">LIHAT TUNJANGAN PROFESI</h2>
        </div>
        ...
        <div className="w-full bg-white p-6 rounded-lg shadow-lg mt-10">
          ...
          <div className="flex justify-end">
            <Link
              href={`/dosen/pembayaran/lihat-profesi/${kdtunjangan}`}
