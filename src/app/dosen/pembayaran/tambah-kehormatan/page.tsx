...
export default function TambahKehormatanPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const confirmation = await Swal.fire({
      title: "Simpan Data?",
      text: "Apakah Anda yakin ingin menyimpan data Tanggal Tunjangan Kehormatan ini?",
      icon: "warning",
    ...
    try {
      ...
      if (response.status === 201) {
        ...
        router.push("/dosen/pembayaran/tunjangan-kehormatan");
      } else {
  ...
  return (
    <section className=" text-black px-16">
      ...
      <div className="max-w-6xl mx-auto bg-white p-8 rounded-lg shadow-lg mt-10">
        <h1 className="text-2xl font-bold mb-8">TAMBAH TUNJANGAN KEHORMATAN</h1>
