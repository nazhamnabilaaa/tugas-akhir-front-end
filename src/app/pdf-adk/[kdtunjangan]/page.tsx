        ...
        const filteredData = data.flatMap((item) => {
          if (Array.isArray(item)) {
            return item.filter((innerItem) =>
              innerItem.kdtunjangan && String(innerItem.kdtunjangan) === String(kdtunjangan)
            );
          }
          return [];
        });
          ...
          <tbody className="text-black">
            {mergedData.map((item, index) => (
              ...
              >
                ...
                <td className="border border-gray-400 px-3 py-2">{item.kdanak}</td>
                ...
                <td className="border border-gray-400 px-3 py-2">{item.npwp}</td>
                <td className="border border-gray-400 px-3 py-2">{item.nmrek}</td>
                <td className="border border-gray-400 px-3 py-2">{item.nm_bank}</td>
